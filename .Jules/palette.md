...
## 2025-04-21 - [Accessibility: Hover-only actions]
**Learning:** Found multiple contextual actions hidden by default on hover (`opacity-0 group-hover:opacity-100`) that are inaccessible to keyboard users.
**Action:** Always add `focus-within:opacity-100` to their parent containers and explicit focus states (e.g., `focus-visible:opacity-100 focus-visible:ring-2`) to the interactive elements themselves.
