...
try:
    ...
    raise ImportError("Matrix dependencies not installed. Run: pip install TARS-ai[matrix]") from e
...
from TARS.config.paths import get_data_dir, get_media_dir
from TARS.config.schema import Base
from TARS.utils.helpers import safe_filename
