        ...
        try:
            ...
            for _ in range(max_redirects + 1):
                ...
                if resp.status in (301, 302, 303, 307, 308):
                    ...
                    resp.close()
                    if not location:
                        logger.warning("QQ outbound media redirect missing Location header url={}", current_url)
                        return None, None
        ...
        try:
            ...
            for _ in range(max_redirects + 1):
                ...
                if resp.status in (301, 302, 303, 307, 308):
                    ...
                    resp.close()
                    if not location:
                        logger.warning("QQ download redirect missing Location header url={}", current_url)
                        return None
