...
class SessionManager:
    ...
    def search_sessions(self, query: str) -> list[dict[str, Any]]:
        ...
        # ⚡ Bolt: Compile regex once to avoid O(N) lower() allocations on every line of chat history
        import re
                        ...
                        for line in f:
                            if query_re.search(line):
                                ...
                                if data.get("role") in ("user", "assistant"):
                                    ...
                                    # ⚡ Bolt: Exact type checking is faster than isinstance
                                    if type(content) is str and query_re.search(content):
                                        match = True
                                        break
