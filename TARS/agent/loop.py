...
if TYPE_CHECKING:
    from TARS.config.schema import ChannelsConfig, ExecToolConfig, WebSearchConfig
...
class AgentLoop:
    ...
    def __init__(
        ...
        from TARS.config.schema import ExecToolConfig, WebSearchConfig
        ...
        # TARS_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("TARS_MAX_CONCURRENT_REQUESTS", "3"))
    ...
    def _register_default_tools(self) -> None:
        ...
        # Register file_manager skill tools
        for tool in get_file_manager_tools(
    ...
    async def _connect_mcp(self) -> None:
        ...
        from TARS.agent.tools.mcp import connect_mcp_servers
        try:
    ...
    def _set_tool_context(self, channel: str, chat_id: str, message_id: str | None = None) -> None:
        ...
        for name in ("message", "spawn", "cron", "send_file_to_user"):
            if tool := self.tools.get(name):
                if hasattr(tool, "set_context"):
                    tool.set_context(channel, chat_id, *([message_id] if name in ("message", "send_file_to_user") else []))
    ...
    def _strip_think(text: str | None) -> str | None:
        ...
        if not text:
            return None
        from TARS.utils.helpers import strip_think
        ...
        *,
        ...
        for block in content:
            ...
            if (
                ...
                and isinstance(image_url := block.get("image_url"), dict)
