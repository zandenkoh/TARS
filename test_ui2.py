...
def run_cuj(page):
    ...
    page.screenshot(path="/home/jules/verification/screenshots/search_modal_with_button.png")
    page.wait_for_timeout(1000)
    ...
    page.wait_for_timeout(2000)
    page.screenshot(path="/home/jules/verification/screenshots/projects_modal.png")
    page.wait_for_timeout(1000)
